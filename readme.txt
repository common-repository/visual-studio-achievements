...
Shows your Visual Studio Achievements, using the Achievements API. Supports options for default CSS (more 
...
3. Configure the widget from the Appearence -> Widgets menu

== Frequently Asked Questions ==

= Why doesn't it support option XYZ from the achievements API? =

Because this is pretty much the first version. Tell me what you need and I will add it!

== Screenshots ==

1. The widget editor options
